...
var Form = (0, import_react9.forwardRef)(
  ({
    ...
    const updateDirtyState = (event) => setIsDirty(event.type === "reset" ? false : !(0, import_lodash_es2.isEqual)(getData(), (0, import_core5.formDataToObject)(defaultData.current)));
